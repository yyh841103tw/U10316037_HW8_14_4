...
class Loan {
	...
	public Loan(double annualInterestRate, int numOfYears,double loanAmount) {
		if (annualInterestRate <= 0)
			throw new IllegalArgumentException("annualInterestRate is negative");
		if (numOfYears <= 0)
			throw new IllegalArgumentException("NumberOfYears is negative");
		if (loanAmount <= 0)
			throw new IllegalArgumentException("LoanAmount is negative");
